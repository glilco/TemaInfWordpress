    ...
    <div id="conteudo" class="total-centro">
        <nav id="menu-lateral" class="clear">
            <ul class="menu-lateral-topo">
                ...
                <ul class="menu-lateral-sub">
                    <li class="menu-lateral-subitem"><a href="#">Mestrado</a></li>
                    <li class="menu-lateral-subitem"><a href="#">Doutorado</a></li>
                    <li class="menu-lateral-subitem"><a href="#">Especializações</a></li>
                </ul>
                <li class="menu-lateral-titulo"><a href="#">Pesquisa</a></li>
                <ul class="menu-lateral-sub">
                    <li class="menu-lateral-subitem"><a href="#">Objetivos</a></li>
                    <li class="menu-lateral-subitem"><a href="#">Grupos de Pesquisa</a></li>
                    <li class="menu-lateral-subitem"><a href="#">Projetos</a></li>
                    <li class="menu-lateral-subitem"><a href="#">Compêndio</a></li>
                </ul>
                <li class="menu-lateral-titulo"><a href="#">Extensão</a></li>
                <ul class="menu-lateral-sub">
                    <li class="menu-lateral-subitem"><a href="#">Objetivo</a></li>
