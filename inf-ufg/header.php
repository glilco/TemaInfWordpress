        ...
        <div id="grupo-cabecalho" class="total-centro link-limpo-container">
            <div id="grupo-links-conteudo" class="link-limpo-container link-limpo-container-hover">
                ...
                <ul>
                    ...
                    <li><a href="#rodape"  accesskey="4" tabindex="4">Ir para o rodapé <span>4</span></a></li>
            ...
            <div id="id-inf">
                <div>
                    <a href="/">
                        <h1>INF</h1>
                        <span>INSTITUTO DE INFORMÁTICA</span>
                    </a>
                </div>
            </div>
            <div id="id-ufg">
            ...
            <div id="grupo-barra-superior" class="total-centro">
                ...
                <div id="grupo-busca-barra-superior" class="elemento-barra-superior">
                    ...
                    <form action="/news" accept-charset="UTF-8" method="get" role="search">
                        <fieldset>
                            <input class="campo-busca" type="search" name="s" placeholder="Buscar no site" />
                            <input class="botao-busca" type="submit" value="Buscar no site" />
                        </fieldset>
                    </form>
                </div>
                
                <nav id="menu-barra-superior">
                    <ul class="menu-dropdown menu link-limpo-container">
